...
from episode05.common import BoardStates, NormClueType
...
class BoardPlotter:
    ...
    def __init__(self, a_puzzle: Puzzle):
        ...
        self.sequence: List[BoardStates] = []
    ...
    def show(self, a_board: BoardStates) -> None:
        """Plot the board."""
        # set some canvas
    ...
    def append_to_sequence(self, a_board: BoardStates) -> None:
    ...
    def show_many(self, some_boards: List[BoardStates]) -> None:
        """Plot several boards."""
        # max 12
    ...
    # private method
    def _plot(self, data: BoardStates, ax: Any) -> None:
